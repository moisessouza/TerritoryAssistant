...
public class MainActivity extends AppCompatActivity
    ...
    /**
     * Guardando contexto de forma estática
     */
    ...
    private void goToExportarDados() {
        ...
        try {
            ...
            shareIntent.putExtra(Intent.EXTRA_STREAM, FileProvider.getUriForFile(getApplicationContext(), "com.example.myapp.fileprovider", dst));
    ...
    public File createOrReturnFile () throws IOException {
        File folder = new File(getExternalFilesDir("TerritoryAssistant"), "dump");
